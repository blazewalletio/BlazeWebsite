/**
 * Copy for waitlist presale drip emails. Each key = one send moment (24h, 3d, and so on after post-series, or apr30 17:00 UTC).
...
const PRESALE_DRIP_COPY: Record<PresaleDripKey, DripCopy> = {
  '24h': {
    ...
    body: 'While others are still thinking about it, you can act. The BLAZE presale is live for everyone, with the same presale price and the same bonus tiers. The only thing that changes over time is how many people are ahead of you in the queue. Secure your $BLAZE now and lock in your tier before the rush.',
  },
  '3d': {
  ...
  '14d': {
    ...
    body: 'Two weeks ago we opened the presale for everyone. The window doesn’t stay open forever: it closes on 30 April. After that it’s TGE and distribution, with no more presale and no more bonus tiers at this price. If you’ve been on the fence, this is your reminder: the chance is real and time-limited.',
  },
  '17d': {
  ...
  '36d': {
    ...
    body: 'In four days the presale ends. After 30 April the only way to get BLAZE is at launch price, with no presale discount and no bonus tiers. Right now you can still secure your allocation at $0.008333 per token and claim your tier bonus. Four days to decide; then the door closes.',
  },
  '40d': {
